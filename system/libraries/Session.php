...
class CI_Session {
	 ...
	 * @return	void
	 */
	function set_userdata($new_data = array(), $newval = '')
	{
		if (is_string($new_data))
		{
			$new_data = array($new_data => $newval);
		}
	 ...
	 * @return	void
	 */
	function unset_userdata($new_data = array())
	{
		if (is_string($new_data))
		{
	 ...
	 * @return	void
	 */
	function set_flashdata($new_data = array(), $newval = '')
	{
		if (is_string($new_data))
		{
			$new_data = array($new_data => $newval);
